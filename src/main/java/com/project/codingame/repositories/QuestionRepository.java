...
public class QuestionRepository implements IQuestionRepository {
    ...
    public List<Question> findAll() {
        ...
        for(Question each : questionMap.values()){
            questions.add(each);
        }
     return questions;
    }
    ...
    public void delete(Question entity) {
        // TODO Auto-generated method stub
        if(questionMap.containsValue(entity)){
    ...
    public List<Question> findAllQuestionLevelWise(Level level) {
        List<Question> questionsOfLevel=new ArrayList<>();
        for(Question question : questionMap.values()){
            if(question.getLevel()==level){
                questionsOfLevel.add(question);
            }
        }
